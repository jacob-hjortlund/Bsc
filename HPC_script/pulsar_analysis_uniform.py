...
def loglikelihood_uniform(theta, data, kernel=rbf):
...
def logposterior(theta): #data, logprior, kernel=rbf):
    ...
    return lp + loglikelihood_uniform(theta, data, kernel=kernel)
...
np.save(path + f'{kernel_name}_uniform_likelihood.npy', samples)
